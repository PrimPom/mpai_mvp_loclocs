...
export default function HeroAbout() {
  return (
    <section className="relative bg-cover bg-center w-full min-h-screen flex flex-col items-center justify-center px-4 py-20" style={{ backgroundImage: "url('/about/about-image.jpg')" }}>
      {/* Titre principal */}
